    ...
    public class ListagemPersonagemViewModel : BaseViewModel
    {
        ...
        public async Task ObterPersonagens() {
            ...
            try
            {
                ...
                OnPropertyChanged(nameof(Personagens)); // Transformará a View que houve carregamento.
        ...
        public async Task ExibirCadastroPersonagem()
        {
            try
            {
                await App.Current.MainPage.Navigation.PushAsync(new Views.Personagens.CadastroPersonagemView());
            }
            catch (Exception ex)
            {
